...
const navigation = [
  ...
  { name: 'Team', href: 'login' },
  { name: 'Projects', href: 'register' },
...
export default function Header(props) {
  return (
    <>
        ...
        {({ open }) => (
          <>
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
              <div className="relative flex h-13 items-center justify-between h-10">
      ...
      <div className="max-w-7xl mx-auto bg-slate-300 min-h-screen px-2 py-2">    
      {props.children}
      </div>
      </div>
    </>
